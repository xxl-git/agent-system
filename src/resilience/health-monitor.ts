...
export class HealthMonitor extends EventEmitter {
  ...
  /** 获取健康监控汇总（供 API/Dashboard 使用） */
  getSummary(): {
    emptyLoopCount: number;
    ...
    return {
      emptyLoopCount: this.consecutiveEmptyCalls,
      consecutiveUnreachable: this.consecutiveUnreachable,
      lastPingTime: this.lastPingTime || null,
      tokenWarning: this.tokenWarned,
