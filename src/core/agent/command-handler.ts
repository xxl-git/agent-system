...
import { getRecoveryOrchestrator } from '../../resilience/orchestrator';
import { getAuditLog } from '../../audit/audit-log';
import { getSummarizer } from '../../memory/summarizer';
import { getSessionRecoverer } from '../../memory/session-recovery';
import { getDBStore } from '../../memory/db-store';
import { getMemoryStore } from '../../memory/file-store';
import { getCheckpointManager } from '../../resilience/checkpoint';
import { getHealthMonitor } from '../../resilience/health-monitor';
import { getCircuitBreaker } from '../../resilience/circuit-breaker';
import { getExperienceStore, getExperienceExtractor, getExperienceRetriever, getExperienceCommandHandler } from '../../experience';
import { getNonsenseDetector } from '../../resilience/nonsense-detector';
import { getSessionDiagnostics } from '../../resilience/session-diagnostics';
import { getIdleTaskManager } from '../../resilience/idle-task-manager';
import { getContextManager } from '../context-manager';
import { getProfileStore } from '../../models/profile/model-profile';
import { getPromptRegistry, getPromptAssembler } from '../../prompts';
